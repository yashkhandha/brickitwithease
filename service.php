...
<section id="service-page" class="pages service-page">
    ...
    <!--                    <div class="col-md-4">-->
    <!--                        <img src="images/downloaded/low-back-pain-1.jpg"-->
    <!--                             style="height: 215px; width: 350px; margin-top: 55px; margin-left: 40px;"-->
    <!--                             class="image-radius">-->
    <!--                    </div>-->
    <!--                    <div class="col-md-4">-->
    <!--                        <img src="images/downloaded/knee-pain-2.jpg"-->
    <!--                             style="height: 215px; width: 350px; margin-top: 85px; margin-left: 40px;"-->
    <!--                             class="image-radius">-->
    <!--                    </div>-->
            ...
            <div class="col-md-12">
                <div class="block">
                    ...
                    <a href="login.php" class="btn btn-primary btn-contact wow fadeInDown" data-wow-delay=".7s"
                       data-wow-duration="500ms">Click here</a>
                </div>
            </div>
...
<footer id="footer">
    <div class="container">
        ...
        <!--            <ul class="social">-->
        <!--                <li>-->
        <!--                    <a href="https://www.facebook.com/Brick-it-with-ease-832533966917055/?modal=admin_todo_tour"-->
        <!--                       class="Facebook">-->
